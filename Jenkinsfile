pipeline {
  ...
  stages {
    stage('Checkout') {
      steps {
        ...
        credentialsId: 'GitHub_alejandro.jaramillo', url: 'https://github.com/alejojg-1/Clases-particulares.git']]])
      }
    }
  ...
  post {
    ...
    failure {
      ...
      mail(to: 'alejandro.jaramillo@ceiba.com.co', subject: "Failed Pipeline:${currentBuild.fullDisplayName}", body: "Something is wrong with ${env.BUILD_URL}")
    }
    unstable {
